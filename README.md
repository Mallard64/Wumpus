...
push to `master`. Two one-time setup steps:
...
<!-- TODO (Felix): fill this in before sharing the repo.
     This was a team project — the git history has commits from another contributor (zigoola).
     Say plainly which parts you wrote and which were someone else's, for example:
       - What I built: ...
       - What my teammate built: ...
     Recruiters read this section closely, and being specific reads better than being vague. -->

**TODO:** describe who built what.
